...
def _build_alias_map() -> dict[str, str]:
    ...
    add("Brentford", "Brentford FC", "Bees", "Brentford F C", "Brentford FC")
    add(
        "Brighton",
    ...
    add("Fulham", "Fulham FC", "FFC", "Cottagers", "Fulham London", "Fulham Ldn")
    add(
        "Ipswich Town",
        "Ipswich Town FC",
        "Ipswich",
    ...
    add("Liverpool", "Liverpool FC", "LFC", "Reds", "Liverpool F C", "Pool")
    add(
        "Manchester City",
        "Manchester City FC",
        "Man City",
    ...
    add("Burnley", "Burnley FC", "Burnley F C", "Clarets", "BFC", "Burnley FC")
    add(
        "Cardiff City",
        "Cardiff City FC",
        "Cardiff",
    ...
    add("Derby County", "Derby County FC", "Derby", "DCFC", "Rams", "Derby C")
    add(
        "Hull City",
        "Hull City AFC",
        "Hull City FC",
    ...
    add("Luton Town", "Luton Town FC", "Luton", "LTFC", "Hatters", "Luton T")
    add(
        "Middlesbrough",
        "Middlesbrough FC",
        "Boro",
    ...
    add("Oxford United", "Oxford United FC", "Oxford", "OUFC", "Oxford Utd", "Oxford U")
    add(
        "Plymouth Argyle",
        "Plymouth Argyle FC",
        "Plymouth",
    ...
    add("Reading", "Reading FC", "Royals", "RFC", "Reading F C", "Reading FC")
    add(
        "Sheffield United",
        "Sheffield United FC",
        "Sheff Utd",
    ...
    add("Watford", "Watford FC", "Hornets", "WFC", "Watford F C", "Watford FC")
    add(
    ...
    add("Cambridge United", "Cambridge Utd", "Cambridge", "CUFC", "Cambridge U")
    add(
        "Charlton Athletic",
    ...
    add("Leyton Orient", "Leyton Orient FC", "Orient", "LOFC", "Os", "Leyton O")
    add("Lincoln City", "Lincoln", "LCFC", "Imps", "Lincoln C", "Lincoln FC")
    add("MK Dons", "Milton Keynes Dons", "MK Dons FC", "MK D", "Milton Keynes", "MK")
    ...
    add("Stockport County", "Stockport", "County", "SCFC", "Hatters", "Stockport C")
    add("Walsall", "Walsall FC", "Saddlers", "WFC", "Walsall F C")
    add("Wigan Athletic", "Wigan", "Wigan Athletic FC", "Latics", "WAFC", "Wigan A")
    add(
        "Wimbledon",
        "AFC Wimbledon",
        "AFCW",
    ...
    add("Canada", "CAN", "Canucks", "Canada NT", "Les Rouges", "Canada National Team")
    ...
    add("Denmark", "DEN", "Danish Dynamite", "Denmark NT", "Denmark National Team")
    add("Ecuador", "ECU", "La Tri", "Ecuador NT")
    add("Egypt", "EGY", "Pharaohs", "Egypt NT")
    add("England", "ENG", "Three Lions", "England NT", "England National Team")
    add("France", "FRA", "Les Bleus", "France NT", "France National Team")
    add(
        "Germany",
        "GER",
        "Die Mannschaft",
    ...
    add("Iceland", "ISL", "Strákarnir okkar", "Iceland NT", "Iceland National Team")
    ...
    add("Morocco", "MAR", "Atlas Lions", "Morocco NT", "Morocco National Team")
    add(
        "Netherlands",
        "NED",
        "Holland",
    ...
    add("Norway", "NOR", "Folkets Lag", "Norway NT", "Norway National Team")
    add("Paraguay", "PAR", "Los Guaraníes", "Paraguay NT")
    add("Peru", "PER", "La Blanquirroja", "Peru NT")
    add(
        "Poland", "POL", "Biało-Czerwoni", "Poland NT", "Poland National Team", "Polska"
    )
    add(
        "Portugal", "POR", "Seleção das Quinas", "Portugal NT", "Portugal National Team"
    )
    add(
        "Republic of Ireland",
        "IRL",
    ...
    add("Scotland", "SCO", "Tartan Army", "Scotland NT", "Scotland National Team")
    ...
    add("Spain", "ESP", "La Roja", "Spain NT", "Spain National Team", "Espana")
    add("Sweden", "SWE", "Blågult", "Sweden NT", "Sweden National Team")
    add("Switzerland", "SUI", "Nati", "Switzerland NT", "Switzerland National Team")
    add(
        "Turkey",
        "TUR",
        "Ay-Yıldızlılar",
    ...
    add("Ukraine", "UKR", "Zbirna", "Ukraine NT", "Ukraine National Team")
    add(
        "United States",
        "USA",
        "USMNT",
    ...
    add("Wales", "WAL", "Dragons", "Wales NT", "Wales National Team", "Cymru")
    ...
    add("RB Leipzig", "Leipzig", "RBL", "RasenBallsport Leipzig", "RB Leipzig FC")
    add("Bayer Leverkusen", "Leverkusen", "Bayer 04 Leverkusen", "Bayer 04", "Werkself")
    add(
    ...
    add("VfB Stuttgart", "Stuttgart", "VFB Stuttgart", "VfB", "Stuttgart FC")
    add("TSG Hoffenheim", "Hoffenheim", "TSG", "Hoffenheim FC")
    add("VfL Wolfsburg", "Wolfsburg", "VFL Wolfsburg", "Wolfsburg FC", "Die Wolfe")
    add("SC Freiburg", "Freiburg", "SCF", "SC Freiburg FC", "Freiburg FC")
    add(
        "1. FC Union Berlin",
        "Union Berlin",
        "1. FC Union Berlin",
    ...
    add("FSV Mainz 05", "Mainz", "1. FSV Mainz 05", "Mainz 05", "FSV Mainz")
    add("FC Augsburg", "Augsburg", "FCA", "FC Augsburg FC")
    add("Werder Bremen", "Bremen", "Werder", "SV Werder Bremen", "Werder Bremen FC")
    add("FC St. Pauli", "St. Pauli", "Sankt Pauli", "St Pauli", "FC St Pauli")
    add("1. FC Heidenheim", "Heidenheim", "1. FC Heidenheim 1846", "Heidenheim FC")
    add(
        "FC Schalke 04",
        "Schalke",
        "Schalke 04",
    ...
    add("Sevilla", "Sevilla FC", "Seville", "Sevilla F C", "Rojiblancos", "Sevilla FC")
    add(
        "Valencia",
        "Valencia CF",
        "Valencia FC",
    ...
    add("Celta Vigo", "Celta de Vigo", "RC Celta", "Celta", "Celta Vigo FC")
    ...
    add(
        "Fiorentina", "ACF Fiorentina", "Fiorentina FC", "Viola", "Florence", "La Viola"
    )
    add("Bologna", "Bologna FC", "Bologna 1909", "Rossoblu", "Bologna FC 1909")
    add("Torino", "Torino FC", "Torino FC 1906", "Toro", "Turin", "Granata")
    add("Udinese", "Udinese Calcio", "Udinese FC", "Zebrette", "Udinese Calcio FC")
    add("Sampdoria", "UC Sampdoria", "Sampdoria FC", "Blucerchiati", "Sampdoria Genoa")
    add("Cagliari", "Cagliari Calcio", "Cagliari FC", "Isolani", "Sardi")
    add("Empoli", "Empoli FC", "Azzurri", "Empoli Calcio")
    add("Lecce", "US Lecce", "Lecce FC", "Salentini", "Giallorossi Lecce")
    add(
        "Parma", "Parma Calcio 1913", "Parma FC", "Crociati", "Parma Calcio", "Parma FC"
    )
    ...
    add("Monaco", "AS Monaco", "AS Monaco FC", "Monaco FC", "Les Monégasques", "ASM")
    add(
        "Lille",
        "LOSC",
        "LOSC Lille",
    ...
    add("Rennes", "Stade Rennais", "Stade Rennais FC", "Rennes FC", "Les Rouge et Noir")
    ...
    add("Brest", "Stade Brestois", "Stade Brestois 29", "Brest FC", "Les Ty Zefs")
    add("Montpellier", "Montpellier HSC", "Montpellier FC", "MHSC", "La Paillade")
    ...
    add(
        "PSV Eindhoven", "PSV", "PSV Eindhoven FC", "Philips Sport Vereniging", "Boeren"
    )
    add(
        "Feyenoord",
        "Feyenoord Rotterdam",
    ...
    add("AZ Alkmaar", "AZ", "AZ Alkmaar FC", "Alkmaar", "AZ Alkmaar FC")
    add("Twente", "FC Twente", "Twente FC", "FC Twente Enschede", "Tukkers")
    ...
    add("Porto", "FC Porto", "Porto FC", "FCP", "Dragões", "FC Porto FC")
    add(
        "Sporting CP",
        "Sporting Lisbon",
        "Sporting Lisboa",
    ...
    add("Anderlecht", "RSC Anderlecht", "Anderlecht FC", "Paars-Wit", "RSCA")
    ...
    add("Galatasaray", "Galatasaray SK", "Galatasaray FC", "Cimbom", "Gala", "Aslan")
    add(
        "Fenerbahçe",
        "Fenerbahce",
        "Fenerbahçe SK",
    ...
    add("Aberdeen", "Aberdeen FC", "Dons", "Aberdeen F C", "The Dons")
    add(
        "Hibernian",
        "Hibernian FC",
        "Hibs",
    ...
    add(
        "Dundee United", "Dundee United FC", "Dundee Utd", "DUFC", "Dundee U", "Terrors"
    )
    add("Motherwell", "Motherwell FC", "Well", "Motherwell F C", "Steelmen")
    ...
    add("Ross County", "Ross County FC", "County", "Staggies", "Ross County F C")
    add(
        "St. Johnstone",
        "St Johnstone",
        "St. Johnstone FC",
...
class AliasRegistry:
    ...
    def add_alias(self, canonical: str, *variants: str) -> None:
        ...
        logger.info("Added %d aliases for %s", len(variants), canonical)
    ...
    def fuzzy_match(self, name: str) -> str | None:
        ...
        self._fuzzy_cache[key] = (
            best_match if best_dist <= self._max_fuzzy_distance else None
        )
        return self._fuzzy_cache[key]
